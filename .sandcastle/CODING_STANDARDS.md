...
- Client UI is the locked zip chrome: signed-out Landing, gated chat, header recents, no thread rail, no 3D map, no Methodology popover as a page. Preserve accessibility attributes, button semantics, and keyboard/screen-reader affordances when editing UI.
